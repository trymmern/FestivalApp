...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        System.out.println("tjaaaaaaaaaaaaaaaaaaaa");

        Fragment selectedFragment = null;

        switch (item.getItemId()) {
            case R.id.nav_dashboard:
                //fm.beginTransaction().replace(R.id.frame_layout_content, new DashboardFragment()).commit();
                selectedFragment = DashboardFragment.newInstance();
                break;
            case R.id.nav_packing_list:
                //fm.beginTransaction().replace(R.id.frame_layout_content, new PackingListFragment()).commit();
                selectedFragment = PackingListFragment.newInstance();
                break;
        }

        if (selectedFragment != null) {
            System.out.println("HEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEi");
